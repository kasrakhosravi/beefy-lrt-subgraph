...
import {
  ...
  PLATFORM_BEEFY_CLM,
  PLATFORM_BEEFY_CLM_REWARD_POOL,
  PLATFORM_CURVE,
  PLATFORM_GAMMA,
  PLATFORM_ICHI_LYNEX,
  PLATFORM_LYNEX,
...
import { getVaultTokenBreakdownBeefyCLM, getVaultTokenBreakdownBeefyCLMRewardPool } from "./beefy_clm"
...
export function getVaultTokenBreakdown(vault: BeefyVault): Array<TokenBalance> {
  ...
  } else if (vault.underlyingPlatform == PLATFORM_BEEFY_CLM_REWARD_POOL) {
    return getVaultTokenBreakdownBeefyCLMRewardPool(vault)
