...
export function _getChainVaults(network: string): Array<VaultConfig> {
  ...
  if (network === "mainnet") {
    ...
    vaults.push(new VaultConfig("pendle-weeths-26dec24", PLATFORM_PENDLE_EQUILIBRIA, "0x7031c053dd8BB6d01474846CF4F1eFEeBC3beC56"))
  }
  ...
  if (network === "linea") {
    ...
    vaults.push(new VaultConfig("nile-cl-weeth-weth", PLATFORM_BEEFY_CLM, "0x4d13b56f48A6aDD1e59d03735BE79D10e89Cd824", ["0x818CFe11Df8fD790c6CAC127A247bb4439089efa"]))
